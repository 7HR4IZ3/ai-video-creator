...
client = OpenAI(
  ...
  api_key="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",
)

SUPPORTED_BACKENDS = ["openai", "hf", "llama.cpp"]
...
#                 data=json.dumps(data), timeout=request_timeout)
...
#             print(f"Error (retries={retries}): {str(e)}")
#             retries -= 1
#             if retries <= 0:
#                 raise
#             time.sleep(5)
...
class StoryAgent:
    def __init__(self, backend_uri, backend="openai", request_timeout=120,
